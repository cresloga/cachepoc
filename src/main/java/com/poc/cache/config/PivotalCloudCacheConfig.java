...
@EnableCaching
@Profile({ "pcc", "gemfire" })
public class PivotalCloudCacheConfig extends AbstractCloudConfig {
	...
	ClientCache clientCache() {
	    ...
	    ClientCache cache = cloud.getServiceConnector("plans-cache", ClientCache.class, createGemfireConnectorConfig());
		return cache;
	}
